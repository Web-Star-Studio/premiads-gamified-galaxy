...
export const getPanelCardStyles = (variant: "default" | "secondary" | "glass" = "default") => cn(
...
export const getPanelHeaderStyles = () => "flex items-center justify-between p-4 border-b border-galaxy-purple/30 bg-gradient-to-r from-galaxy-purple/20 to-galaxy-blue/20";

export const getPanelButtonStyles = (variant: "primary" | "secondary" | "ghost" = "primary") => cn(
