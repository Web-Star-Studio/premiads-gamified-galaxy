...
const MissionsList = ({
  ...
  return (
    <div className="glass-panel p-4 h-full overflow-y-auto max-h-[600px] fancy-scrollbar">
      ...
      >
        {missions.map((mission) => (
          <motion.div
            ...
            className={cn(
              "p-3 rounded-lg transition-all cursor-pointer flex items-center justify-between",
          ...
          >
            <div className="pr-2 flex-1 min-w-0">
              <h4 className="font-medium text-sm sm:text-base truncate">{mission.title}</h4>
