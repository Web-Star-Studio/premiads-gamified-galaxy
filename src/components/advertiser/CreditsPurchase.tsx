      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
          <div>
            ...
            <p className="text-2xl font-bold text-white">{currentCredits} rifas</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 border border-gray-700 rounded-lg hover:border-blue-500 transition-colors">
            ...
            <p className="text-sm text-gray-400 mb-2">1.000 rifas</p>
          ...
          <div className="p-4 border border-gray-700 rounded-lg hover:border-blue-500 transition-colors">
            ...
            <p className="text-sm text-gray-400 mb-2">5.000 rifas</p>
          ...
          <div className="p-4 border border-gray-700 rounded-lg hover:border-blue-500 transition-colors">
            ...
            <p className="text-sm text-gray-400 mb-2">15.000 rifas</p>
