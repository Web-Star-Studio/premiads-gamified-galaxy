...
const HowItWorks = () => {
  ...
  return <section id="como-funciona" className="py-20 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            {userType === "participante" ? "Em apenas três passos simples, você estará concorrendo a prêmios incríveis." : "Três passos para criar campanhas gamificadas que impulsionam seu negócio."}
          </p>
        </div>

        <motion.div ref={ref} className="grid md:grid-cols-3 gap-8" initial={{
        opacity: 0
      }} animate={isInView ? {
        opacity: 1
      } : {
