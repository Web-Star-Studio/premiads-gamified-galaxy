  ...
  return (
    <section id="cta" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="glass-panel p-12 max-w-5xl mx-auto rounded-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <Button
                variant="outline"
                className="bg-transparent border-white/20 hover:bg-white/5 text-lg py-6"
              >
